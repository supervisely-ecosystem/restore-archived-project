...
def raise_exception_with_troubleshooting_link(error: Exception):
    error.args = (
        f'Something went wrong, read the <a style="color: #20a0ff;" href={g.troubleshooting_link}>Troubleshooting Instructions</a>. If this does not help, please contact us.',
    )
    raise error
